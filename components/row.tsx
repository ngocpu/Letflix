  ...
  return (
    <div className=''>
        ...
        <div className="relative flex items-center group ">
            ...
            <div id={'slider' + id} className='w-full h-[150px] flex gap-5 overflow-x-scroll overflow-y-hidden whitespace-nowrap scroll-smooth scrollbar-hide relative'>
                {movies.map((item, id)=>(
                     <MovieCard data={item} key={id}/>
                ))}
            </div>
